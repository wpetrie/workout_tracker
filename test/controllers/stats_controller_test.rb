...
class StatsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create stat" do
    assert_difference('Stat.count') do
      post stats_url, params: { stat: { comments: @stat.comments, date: @stat.date, weight: @stat.weight } }
    end
  ...
  test "should update stat" do
    patch stat_url(@stat), params: { stat: { comments: @stat.comments, date: @stat.date, weight: @stat.weight } }
